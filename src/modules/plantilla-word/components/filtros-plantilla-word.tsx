...
import { PlantillaWordFormDialog } from "./form/plantilla-word-form-dialog";

export function FiltrosPlantillaWord() {
  const [tipoSolicitud, setTipoSolicitud] = useState("");
  const [openFormDialog, setOpenFormDialog] = useState(false);

  const handleBuscar = () => {
    // Lógica de búsqueda aquí (por ahora solo presentacional)
    console.log("Buscando...", { tipoSolicitud });
  };
